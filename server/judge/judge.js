...
const test = function (problem, submission, op, input, callback) {
...
const addSubmission = (problem, submission, op, input, callback) => {
  queue
    .add(() => test(problem, submission, op, input, callback))
    .then(() => null)
